...
parameters_bagg = [
    {
        ...
        'base_estimator__clf__estimator__C': [0.01, 0.1, 1]
    },
    {
        'base_estimator__clf__estimator': [KNeighborsClassifier()],
        'base_estimator__clf__estimator__n_neighbors': [4, 8, 15],
    ...
    },
    {
        ...
        "base_estimator__clf__estimator__max_depth": [4, 8], 
        "base_estimator__clf__estimator__min_samples_leaf": [5, 15]
    },
    {
        'base_estimator__clf__estimator': [RandomForestClassifier()],
        "base_estimator__clf__estimator__n_estimators": [10, 20, 50, 100],
        "base_estimator__clf__estimator__min_samples_leaf":[2, 10, 50],               
        "base_estimator__clf__estimator__max_depth": list(range(2,5,1)),
        "base_estimator__clf__estimator__min_samples_split": [2, 10, 20]
    },
    {
        'base_estimator__clf__estimator': [GradientBoostingClassifier()],
        "base_estimator__clf__estimator__n_estimators": [20, 60, 100],
        "base_estimator__clf__estimator__learning_rate": [0.01, 0.1, 0.5],
        "base_estimator__clf__estimator__max_depth": [3, 5]
    }
]
...
parameters_smote = [
    ...
    },
    {
        ...
        'clf__estimator__n_neighbors': [4, 8, 15],
    ...
    },
    {
        ...
        "clf__estimator__min_samples_leaf": [5, 15]
    },
    {
        'clf__estimator': [RandomForestClassifier()],
        "clf__estimator__n_estimators": [10, 20, 50, 100],
        "clf__estimator__min_samples_leaf":[2, 10, 50],               
        "clf__estimator__max_depth": list(range(2,5,1)),
